...
def  main():
    ...
    cicdmasterserver_group = get_hosts(ec2,"cicdmasterserver");
    ...
    'cicdmasterserver': {'hosts': cicdmasterserver_group, 'vars': {'group_name': 'CICD Server Group'}}
    }
